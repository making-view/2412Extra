...
Shader "FruitShaderUniversal"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		_Good_albedo("Good_albedo", 2D) = "white" {}
		_Bad_albedo("Bad_albedo", 2D) = "black" {}
		_Good_metallicSmoothness("Good_metallicSmoothness", 2D) = "white" {}
		_Bad_metallicSmoothness("Bad_metallicSmoothness", 2D) = "black" {}
		[Normal]_Good_normal("Good_normal", 2D) = "bump" {}
		[Normal]_Bad_normal("Bad_normal", 2D) = "bump" {}
		_Badness("Badness", Range( 0 , 1)) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _Good_normal_TexelSize;
			float4 _Bad_normal_TexelSize;
			...
			sampler2D _Good_albedo;
			sampler2D _Bad_albedo;
			sampler2D _Good_normal;
			sampler2D _Bad_normal;
			sampler2D _Good_metallicSmoothness;
			sampler2D _Bad_metallicSmoothness;
			UNITY_INSTANCING_BUFFER_START(FruitShaderUniversal)
				UNITY_DEFINE_INSTANCED_PROP(float4, _Good_albedo_ST)
				UNITY_DEFINE_INSTANCED_PROP(float4, _Bad_albedo_ST)
				UNITY_DEFINE_INSTANCED_PROP(float4, _Good_normal_ST)
				UNITY_DEFINE_INSTANCED_PROP(float4, _Bad_normal_ST)
				UNITY_DEFINE_INSTANCED_PROP(float4, _Good_metallicSmoothness_ST)
				UNITY_DEFINE_INSTANCED_PROP(float4, _Bad_metallicSmoothness_ST)
				UNITY_DEFINE_INSTANCED_PROP(float, _Badness)
			UNITY_INSTANCING_BUFFER_END(FruitShaderUniversal)


			float3 CombineSamplesSharp128_g5( float S0, float S1, float S2, float Strength )
			{
				{
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_Good_albedo = input.ase_texcoord8.xy * _Good_albedo_ST_Instance.xy + _Good_albedo_ST_Instance.zw;
				...
				float4 _Bad_albedo_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(FruitShaderUniversal,_Bad_albedo_ST);
				float2 uv_Bad_albedo = input.ase_texcoord8.xy * _Bad_albedo_ST_Instance.xy + _Bad_albedo_ST_Instance.zw;
				
				float localCalculateUVsSharp110_g5 = ( 0.0 );
				float4 _Good_normal_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(FruitShaderUniversal,_Good_normal_ST);
				float2 uv_Good_normal = input.ase_texcoord8.xy * _Good_normal_ST_Instance.xy + _Good_normal_ST_Instance.zw;
				float2 temp_output_85_0_g5 = uv_Good_normal;
				float2 UV110_g5 = temp_output_85_0_g5;
				float4 TexelSize110_g5 = _Good_normal_TexelSize;
				float2 UV0110_g5 = float2( 0,0 );
				float2 UV1110_g5 = float2( 0,0 );
				float2 UV2110_g5 = float2( 0,0 );
				{
				{
				    UV110_g5.y -= TexelSize110_g5.y * 0.5;
				    UV0110_g5 = UV110_g5;
				    UV1110_g5 = UV110_g5 + float2( TexelSize110_g5.x, 0 );
				    UV2110_g5 = UV110_g5 + float2( 0, TexelSize110_g5.y );
				}
				}
				float4 break134_g5 = tex2D( _Good_normal, UV0110_g5 );
				float S0128_g5 = break134_g5.r;
				float4 break136_g5 = tex2D( _Good_normal, UV1110_g5 );
				float S1128_g5 = break136_g5.r;
				float4 break138_g5 = tex2D( _Good_normal, UV2110_g5 );
				float S2128_g5 = break138_g5.r;
				...
				float4 _Bad_metallicSmoothness_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(FruitShaderUniversal,_Bad_metallicSmoothness_ST);
				float2 uv_Bad_metallicSmoothness = input.ase_texcoord8.xy * _Bad_metallicSmoothness_ST_Instance.xy + _Bad_metallicSmoothness_ST_Instance.zw;
				float4 break26 = ( ( tex2D( _Good_metallicSmoothness, uv_Good_metallicSmoothness ) * ( 1.0 - _Badness_Instance ) ) + ( tex2D( _Bad_metallicSmoothness, uv_Bad_metallicSmoothness ) * _Badness_Instance ) );
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float4 _Good_albedo_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(FruitShaderUniversal,_Good_albedo_ST);
				float2 uv_Good_albedo = input.ase_texcoord3.xy * _Good_albedo_ST_Instance.xy + _Good_albedo_ST_Instance.zw;
				float4 tex2DNode19 = tex2D( _Good_albedo, uv_Good_albedo );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				float4 _Good_albedo_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(FruitShaderUniversal,_Good_albedo_ST);
				float2 uv_Good_albedo = input.ase_texcoord4.xy * _Good_albedo_ST_Instance.xy + _Good_albedo_ST_Instance.zw;
				float4 tex2DNode19 = tex2D( _Good_albedo, uv_Good_albedo );
				float _Badness_Instance = UNITY_ACCESS_INSTANCED_PROP(FruitShaderUniversal,_Badness);
				float4 _Bad_albedo_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(FruitShaderUniversal,_Bad_albedo_ST);
				float2 uv_Bad_albedo = input.ase_texcoord4.xy * _Bad_albedo_ST_Instance.xy + _Bad_albedo_ST_Instance.zw;
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				float4 _Good_albedo_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(FruitShaderUniversal,_Good_albedo_ST);
				float2 uv_Good_albedo = input.ase_texcoord2.xy * _Good_albedo_ST_Instance.xy + _Good_albedo_ST_Instance.zw;
				float4 tex2DNode19 = tex2D( _Good_albedo, uv_Good_albedo );
				float _Badness_Instance = UNITY_ACCESS_INSTANCED_PROP(FruitShaderUniversal,_Badness);
				float4 _Bad_albedo_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(FruitShaderUniversal,_Bad_albedo_ST);
				float2 uv_Bad_albedo = input.ase_texcoord2.xy * _Bad_albedo_ST_Instance.xy + _Bad_albedo_ST_Instance.zw;
		...
		Pass
		{
						 ...
						 )
			{
				...
				float localCalculateUVsSharp110_g5 = ( 0.0 );
				float4 _Good_normal_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(FruitShaderUniversal,_Good_normal_ST);
				float2 uv_Good_normal = input.ase_texcoord5.xy * _Good_normal_ST_Instance.xy + _Good_normal_ST_Instance.zw;
				float2 temp_output_85_0_g5 = uv_Good_normal;
				float2 UV110_g5 = temp_output_85_0_g5;
				float4 TexelSize110_g5 = _Good_normal_TexelSize;
				float2 UV0110_g5 = float2( 0,0 );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input ) : SV_Target
			{
				...
				float4 _Good_albedo_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(FruitShaderUniversal,_Good_albedo_ST);
				float2 uv_Good_albedo = input.ase_texcoord.xy * _Good_albedo_ST_Instance.xy + _Good_albedo_ST_Instance.zw;
				float4 tex2DNode19 = tex2D( _Good_albedo, uv_Good_albedo );
...
WireConnection;42;87;17;0
WireConnection;41;87;16;0
WireConnection;31;0;42;40
...
ASEEND*/
//CHKSM=F3F8D15D1C60AAC0E79F61CA49D284554F4B798F