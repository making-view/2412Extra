	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float4 color28 = IsGammaSpace() ? float4(0.3207547,0.2994564,0.2284621,0) : float4(0.08393918,0.07297008,0.04267583,0);
				float4 blendOpSrc27 = _Color;
				float4 blendOpDest27 = color28;
				float time21 = 0.0;
				float2 voronoiSmoothId21 = 0;
				float pixelWidth31 =  1.0f / 600.0;
				float pixelHeight31 = 1.0f / 600.0;
				half2 pixelateduv31 = half2((int)(input.ase_texcoord8.xy.x / pixelWidth31) * pixelWidth31, (int)(input.ase_texcoord8.xy.y / pixelHeight31) * pixelHeight31);
				float2 break32 = pixelateduv31;
				float mulTime23 = _TimeParameters.x * 0.04;
				float2 temp_cast_0 = (( break32.y + mulTime23 )).xx;
				float2 coords21 = temp_cast_0 * 59.1;
				float2 id21 = 0;
				float2 uv21 = 0;
				float voroi21 = voronoi21( coords21, time21, id21, uv21, 0, voronoiSmoothId21 );
				float4 lerpBlendMode27 = lerp(blendOpDest27,2.0f*blendOpDest27*blendOpSrc27 + blendOpDest27*blendOpDest27*(1.0f - 2.0f*blendOpSrc27),voroi21);
				
				float2 appendResult26 = (float2(break32.x , ( break32.y + ( ( 0.5 - voroi21 ) / 298.5 ) )));
				float pixelWidth36 =  1.0f / 600.0;
				float pixelHeight36 = 1.0f / 600.0;
				half2 pixelateduv36 = half2((int)(appendResult26.x / pixelWidth36) * pixelWidth36, (int)(appendResult26.y / pixelHeight36) * pixelHeight36);
				

				float3 BaseColor = ( saturate( lerpBlendMode27 )).rgb;
				float3 Normal = float3(0, 0, 1);
				float3 Emission = tex2D( _ScreenRender, pixelateduv36 ).rgb;
				float3 Specular = 0.5;
				float Metallic = 1.0;
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				float pixelWidth31 =  1.0f / 600.0;
				float pixelHeight31 = 1.0f / 600.0;
				half2 pixelateduv31 = half2((int)(input.ase_texcoord4.xy.x / pixelWidth31) * pixelWidth31, (int)(input.ase_texcoord4.xy.y / pixelHeight31) * pixelHeight31);
				float2 break32 = pixelateduv31;
				float mulTime23 = _TimeParameters.x * 0.04;
				float2 temp_cast_0 = (( break32.y + mulTime23 )).xx;
				float2 coords21 = temp_cast_0 * 59.1;
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				float pixelWidth31 =  1.0f / 600.0;
				float pixelHeight31 = 1.0f / 600.0;
				half2 pixelateduv31 = half2((int)(input.ase_texcoord2.xy.x / pixelWidth31) * pixelWidth31, (int)(input.ase_texcoord2.xy.y / pixelHeight31) * pixelHeight31);
				float2 break32 = pixelateduv31;
				float mulTime23 = _TimeParameters.x * 0.04;
				float2 temp_cast_0 = (( break32.y + mulTime23 )).xx;
				float2 coords21 = temp_cast_0 * 59.1;
...
/*ASEBEGIN
Version=19801
Node;AmplifyShaderEditor.RangedFloatNode;12;-336,128;Inherit;False;Constant;_Float0;Float 0;2;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;13;-336,256;Inherit;False;Constant;_Float1;Float 1;2;0;Create;True;0;0;0;False;0;False;0.9;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;15;-1152,-384;Inherit;True;Property;_ScreenRender;ScreenRender;2;0;Create;True;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.SamplerNode;14;-864,-32;Inherit;True;Property;_TextureSample0;Texture Sample 0;1;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SimpleSubtractOpNode;19;-2096,240;Inherit;False;2;0;FLOAT;0.5;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;22;-2528,288;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;17;-1696,128;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;26;-1536,48;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TexCoordVertexDataNode;16;-3332,64;Inherit;False;0;2;0;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.BreakToComponentsNode;32;-2768,64;Inherit;False;FLOAT2;1;0;FLOAT2;0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
Node;AmplifyShaderEditor.VoronoiNode;21;-2368,320;Inherit;True;0;0;1;0;1;False;1;False;False;False;4;0;FLOAT2;0,0;False;1;FLOAT;0;False;2;FLOAT;59.1;False;3;FLOAT;0;False;3;FLOAT;0;FLOAT2;1;FLOAT2;2
Node;AmplifyShaderEditor.SimpleTimeNode;23;-2784,416;Inherit;False;1;0;FLOAT;0.04;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;11;-864,576;Inherit;False;Property;_Color;Color;1;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode;28;-896,832;Inherit;False;Constant;_Color2;Color 2;1;0;Create;True;0;0;0;False;0;False;0.3207547,0.2994564,0.2284621,0;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.BlendOpsNode;27;-512,416;Inherit;True;SoftLight;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;1;False;1;COLOR;0
Node;AmplifyShaderEditor.TFHCPixelate;31;-3072,64;Inherit;True;3;0;FLOAT2;0,0;False;1;FLOAT;600;False;2;FLOAT;600;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TFHCPixelate;36;-1248,48;Inherit;True;3;0;FLOAT2;0,0;False;1;FLOAT;600;False;2;FLOAT;600;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleDivideOpNode;20;-1872,256;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;298.5;False;1;FLOAT;0
...
WireConnection;22;0;32;1
WireConnection;22;1;23;0
WireConnection;17;0;32;1
...
ASEEND*/
//CHKSM=DAE57541E44BF12344203477FD3B7F3594C8C5B2